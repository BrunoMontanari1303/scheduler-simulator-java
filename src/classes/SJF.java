...
public class SJF implements Escalonador {
    ...
    public SJF(List<Tarefa> tarefasOriginais) {
        this.tarefasOriginais = tarefasOriginais;
        this.filaPronto = new PriorityQueue<>(Comparator.comparingInt(InstanciaTarefa::getCtRestante));
    ...
    public void simular(List<Tarefa> listaTarefas, int tempoSim) {
        ...
        do {
            //Libera periodicamente as instâncias
            ...
            //Se processador está vazio, pega a de menor CT da fila
