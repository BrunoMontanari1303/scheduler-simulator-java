...
public class FCFS implements Escalonador {
    ...
    public FCFS(List<Tarefa> tarefasOriginais) {
        this.tarefasOriginais = tarefasOriginais;
        filaPronto = new LinkedList<>();
        processador = new LinkedList<>();
    }
    ...
    public void simular(List<Tarefa> listaTarefas, int tempoSim) {
        ...
        do {
            //Liberação periódica de instâncias
            ...
            //Se o processador está vazio, pega a próxima da fila
